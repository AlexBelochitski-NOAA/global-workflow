...
&gfs_physics_nml
  ...
  evpco          = ${evpco:-"2.0d-5"}
  wminco         = ${wminco:-"1.0d-5,1.0d-5"}
  sup            = ${sup:-"1"}
  ras            = ${ras:-.false.}
  cscnv          = ${cscnv:-.false.}
  do_shoc        = ${do_shoc:-.false.}
  shoc_diag      = ${shoc_diag:-.false.}
  shoc_parm      = ${shoc_parm:-"7000.0,1.0,4.2857143,0.7,-999.0,2"}
  do_aw          = ${do_aw:-.false.}
  shoc_cld       = ${shoc_cld:-.false.}
  cs_parm        = ${cs_parm:-"8.0,4.0,1.0e3,3.5e3,20.0,1.0,-999.,1.,0.6,0."}
  crtrh          = ${crtrh:-"1.00,1.00,1.00"}
  xkzm_h         = ${xkzm_h:-1.0}
  xkzm_m         = ${xkzm_m:-1.0}
  xkzm_s         = ${xkzm_s:-1.0}
